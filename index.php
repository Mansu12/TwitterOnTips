...
define('CONSUMER_KEY', 'QeOHdpw6HFnptIvDBvlWGrPZS');
define('CONSUMER_SECRET', 'idmOxE3xA1Fw2UHqKGk5yqeBpiMfiW0jLgiD1VmRgn5KN0ilPq');
define('OAUTH_CALLBACK', 'http://127.0.0.1/twitter');
// start the session
session_start();
...
if(isset($_GET['oauth_token'])){
	...
	if($access_token){	
		...
		// get the data
		$data = $connection->get('statuses/home_timeline',$params);
		if($data){
